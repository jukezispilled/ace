  ...
  return (
    ...
    >
      <div className='absolute bottom-4 right-4 flex space-x-1 items-center z-[50]'>
        <a href="https://x.com/aceacesol" className='transition ease-in-out duration-150'>
        ...
        <a href="https://t.me/ACESOLANAPORTAL" className='transition ease-in-out duration-150'>
